...
class Cinch::WorldWeather
  ...
  def weather(location)
    ...
    uri = URI.parse("https://api.worldweatheronline.com/free/v1/weather.ashx?q=#{URI.encode(location)}&format=JSON&extra=localObsTime&fx=no&includelocation=yes&key=#{APIKEY}")
